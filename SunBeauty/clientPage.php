...
<?php  include_once'includes/header.php'?>
    <header class="site-header">
        ...
        <div class="nav-container">
            <a href="account.php">
                <img src="Images/icons/account-icon.png" alt="Account" id="accountIcon" class="nav-icon" title=" <?php echo "".$name; ?>">
            </a>
            <a href="cart.php">
    ...
    <body>
      <section class="main-content">
        <div class="banner">
            <img src="Images/icons/banner.png" alt="Banner Image" class="banner-image">
        </div>
        <!-- Add more sections for products and offers here -->
      </section>
      <!-- ... (previous code remains the same) -->

 <section class="products">
    <div class="product-container" id="product1" onmouseover="showDescription('product1');" onmouseout="hideDescription('product1');">
        ...
        <div class="product-details">
            ...
            <span class="product-price">99.00 Dh</span>
    ...
    <div class="product-container" id="product2" onmouseover="showDescription('product2');" onmouseout="hideDescription('product2');">
    ...
    <div class="product-container" id="product3" onmouseover="showDescription('product3');" onmouseout="hideDescription('product3');">
    ...
    <div class="product-container" id="product4" onmouseover="showDescription('product4');" onmouseout="hideDescription('product4');">
...
<section class="offer-of-the-month">
    <div class="center-container" id="centerContainer" onmouseover="showDescription('centerContainer');" onmouseout="hideDescription('centerContainer');">
        <img src="Images/icons/10percentoff.jpg" alt="10% OFF" class="offer-image">
        <div class="product-details">NEW</div>
        <div class="product-description" id="descriptionCenter">Special offer for this month!</div>
    </div>
